<div class='container main'>
	...
	<div class='comment'>
		...
		<div class="comment__main">
			...
			<div class="comment__icon">
				...
				<?php
					echo "<img src='avatar/". ($data['id'] % 9 + 1) .".png' class='comment__avatar' />";
				?>
				<div class="comment__userinfo">
				<?php
					echo "<div class='comment__nickname'>".$data['nickname']."</div>";
				?>
					<div class='comment__createdat'><?php echo $data["created_at"];?></div>
				</div>
				<?php
		...
		<div class='comment__sub__display'>
			...
			<div class="comment__icon">
				<?php
					echo "<img src='avatar/". ($data1['id'] % 9 + 1) .".png' class='comment__avatar' />";
				?>
				<div class="comment__userinfo">
				<?php
					echo "<div class='comment__nickname'>".$data1['nickname']."</div>";
				?>
					<div class='comment__createdat'><?php echo $data1["created_at"];?></div>
				</div>
				<?php
	...
	<!-- 這是包含了 comment__main 跟 comment__sub 的結尾 (comment的結尾) -->
	</div>
	<?php
		// 這是主留言 while 迴圈的結尾
		}
